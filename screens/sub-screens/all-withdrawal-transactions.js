...
export default function AllTransactions() {
  ...
  const renderItem = ({ item, index }) => (
    <View style={styles.row}>
      ...
      <Text style={[styles.cell, { minWidth: 80 }]}>{item.trans_type}</Text>
      <Text style={[styles.cell, { minWidth: 150 }]}>{item.withdraw_method}</Text>
      <Text style={[styles.cell, { minWidth: 120 }]}>{item.createdAt}</Text>
      <Text style={[styles.cell, { minWidth: 100 }]}>{item.status}</Text>
    </View>
  );
      ...
      <SafeAreaView style={styles.tableContainer}>
        <ScrollView horizontal>
          <View style={[styles.table, { minWidth: screenWidth }]}>
            <Text style={{ fontSize: 20, width: 150, marginBottom: 15 }}>All Transactions</Text>
            <View style={styles.headerContainer}>
              <View style={styles.headerRow}>
                ...
                <Text style={[styles.headerCell, { minWidth: 150 }]}>Withdraw Method</Text>
